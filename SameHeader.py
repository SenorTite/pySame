...
# Author: SenorTite
#
# DISCLAIMER: The PySame repository and all its files (i.e. "the software") are provided for entertainment,
# educational and demonstrative purposes only, without warranty of any kind, either expressed or implied. Any 
# use of EAS tones generated by the software is therefore solely under the responsibility of the party which
# has committed the usage directly. The software and its author are not affiliated, associated, approved by,
# or otherwise related to any authority, organization or agency which uses or implements the Specific Area
# Message Encoding protocol (SAME) for official purposes. UNDER NO CIRCUMSTANCE SHALL THE AUTHOR OF THE
# SOFTWARE BE ACCOUNTABLE FOR ANY LOSS OR DAMAGE OR HAVE ANY OTHERWISE VALID LIABILITY ASSOCIATED IN ANY WAY
# WITH USAGE OF EAS TONES GENERATED USING THE SOFTWARE.
#
