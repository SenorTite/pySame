...
# Author: SenorTite
#
# DISCLAIMER: This software is provided for entertainment, educational and demonstrative purposes only, without warranty any kind,
# either expressed or implied. Any use of EAS tones generated by this software is therefore solely under the responsibility of the
# individual/s who directly committed the above. The software and its author are not affiliated, associated, approved, or
# otherwise related to any organization or party which uses or implements the Specific Area Message Encoding protocol (SAME) for
# official purposes. UNDER NO CIRCUMSTANCE SHALL THE AUTHOR OF THIS SOFTWARE BE ACCOUNTABLE FOR ANY LOSS OR DAMAGE OR HAVE ANY
# OTHERWISE VALID LIABILITY ASSOCIATED IN ANY WAY WITH USAGE OF EAS TONES GENERATED USING THIS SOFTWARE.
#
