...
# Author: SenorTite
#
# DISCLAIMER: The software (i.e. the PySame repository and all its contents) is provided for entertainment,
# educational and demonstrative purposes only, without warranty of any kind, either expressed or implied.
# By using the software, you hereby consent that you will be solely responsible for any subsequent event or
# action taking place from such use, including but not limited to any usage of EAS tones generated by the
# software. The software and its author are not affiliated, approved by, or otherwise related to any
# organization or authority which uses or implements the Specific Area Message Encoding protocol (SAME) for
# official purposes. UNDER NO CIRCUMSTANCE SHALL THE AUTHOR OF THE SOFTWARE BE ACCOUNTABLE FOR ANY LOSS OR
# DAMAGE OR HAVE ANY OTHERWISE VALID LIABILITY ASSOCIATED IN ANY WAY WITH USAGE OF EAS TONES GENERATED
# USING THE SOFTWARE.
#
#
