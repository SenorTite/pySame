...
# use of EAS tones generated by the software is therefore solely under the responsibility of the individual/s
# who has committed the usage directly. The software and its author are not affiliated, associated, approved,
# or otherwise related to any organization or party which uses or implements the Specific Area Message Encoding
# protocol (SAME) for official purposes. UNDER NO CIRCUMSTANCE SHALL THE AUTHOR OF THE SOFTWARE BE ACCOUNTABLE
# FOR ANY LOSS OR DAMAGE OR HAVE ANY OTHERWISE VALID LIABILITY ASSOCIATED IN ANY WAY WITH USAGE OF EAS TONES
