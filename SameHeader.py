...
#
# The software and its author are not affiliated, associated, authorized, endorsed by, or
# connected with any official organization or party which uses, implements, or otherwise
# utilizes the Specific Area Message Encoding (SAME) protocol.
#
#
